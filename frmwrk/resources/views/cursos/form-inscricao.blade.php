...
@section('title') Pré-inscrição no curso {{$evento->curso}} @endsection
    ...
    <div class="bg-titulo">
        <div class="titulo">
            <ul>
                ...
                <li><a href="cursos/{{str_slug($evento->modalidade)}}">{{$evento->modalidade}}</a></li>
                <li><a>Pré-Inscrição</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="bg-conteudo">
        ...
        <article class="conteudo">
            ...
            <div class="conteudo-texto form">
                <p>Preencha este cadastro prévio à sua inscrição e em breve entraremos em contato com você.</p>
                ...
                <form id="preinscricao" class="formulario" action="{{ action('ParaVoceController@sendInscricao') }}"
                      method="Post">

                    <label class="clear">
                        <strong><spam>*</spam>Nome:</strong>
                        <input type="text" name="nome" required title="Informe seu nome"/>
                    </label>
                    <label class="duplo">
                        <strong><spam>*</spam>CPF:</strong>
                        <input type="text" class="cpf valid" name="cpf" required title="Informe seu cpf"/>
                    </label>
                        <label class="duplo">
                    ...
                    <label class="duplo">
                        <strong>
                            <spam>*</spam>
                            Celular:</strong>
                        <input type="text" required class="celular" name="celular"/>
                    </label>
                    ...
                    <input type="hidden" name="id_forma_recebimento" value="17"/>
