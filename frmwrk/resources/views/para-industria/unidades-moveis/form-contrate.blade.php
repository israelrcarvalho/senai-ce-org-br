...
@section('title') Contrate {{$servico->nome}} @endsection
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{url(env('PATH_ASSETS').'/shared/js/lib/jquery/jquery-validation-1.13.1/dist/jquery.validate.min.js')}}"></script>
    <script type="text/javascript" src="{{url(env('PATH_ASSETS').'/shared/js/lib/jquery/jquery.maskedinput.min.js')}}"></script>
...
@section('conteudo')
    ...
    <div class="bg-conteudo">
        ...
        <article class="conteudo">
            <h3 class="titulo-separar"><a href="">{{$servico->nome}}</a></h3>
            ...
            <div class="conteudo-texto form">
                ...
                <form id="form-contratar" class="formulario" action="{{ action('ParaVoceController@sendInscricao') }}"
                    ...
                    <label class="duplo">
                        ...
                        <input class="cnpj_" type="text" required="" name="cnpj" aria-required="true" aria-invalid="false">
                    </label>
                    <label class="duplo">
                    ...
                    <label class="duplo">
                        <strong><spam>*</spam> Telefone:</strong>
                    ...
                    <input type="hidden" name="pag_contratar" value="{{$servico->nome}}">
                </form>
