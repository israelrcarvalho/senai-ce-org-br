...
@section('title') Contrate {{$servico->conteudo_nome}} @endsection
    ...
    <div class="bg-titulo">
        <div class="titulo">
            <ul>
                ...
                <li><a href="para-industria/{{$servico->conteudo_id}}/{{str_slug($servico->conteudo_nome)}}">{{$servico->conteudo_nome}}</a></li>
                <li><a>Contrate</a></li>
            </ul>
        </div>
    </div>
